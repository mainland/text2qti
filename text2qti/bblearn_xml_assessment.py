  ...
  <assessment ident="{assessment_identifier}" title="{title}">
    <rubric view="All">
      <flow_mat class="Block">
        <material>
          <mat_extension>
            <mat_formattedtext type="HTML">{instructions_html_xml}</mat_formattedtext>
          </mat_extension>
        </material>
      </flow_mat>
    </rubric>
    <presentation_material>
      <flow_mat class="Block">
        <material>
          <mat_extension>
            <mat_formattedtext type="HTML">{description_html_xml}</mat_formattedtext>
          </mat_extension>
        </material>
      </flow_mat>
    </presentation_material>
          ...
          <flow class="Block">
            <flow class="QUESTION_BLOCK">
              <flow class="FORMATTED_TEXT_BLOCK">
                <material>
                  <mat_extension>
                    <mat_formattedtext type="HTML">{question_html_xml}</mat_formattedtext>
                  </mat_extension>
                </material>
              </flow>
            </flow>
                  ...
                  <flow_label class="Block">
                    <response_label ident="{ident}">
                      <flow_mat class="FORMATTED_TEXT_BLOCK">
                        <material>
                          <mat_extension>
                            <mat_formattedtext type="HTML">{choice_html_xml}</mat_formattedtext>
                          </mat_extension>
                        </material>
                      </flow_mat>
                    </response_label>
        ...
        <itemfeedback ident="correct">
          <flow_mat class="Block">
            <flow_mat class="FORMATTED_TEXT_BLOCK">
              <material>
                <mat_extension>
                  <mat_formattedtext type="HTML">{feedback}</mat_formattedtext>
                </mat_extension>
              </material>
            </flow_mat>
          </flow_mat>
...
def assessment(*, quiz: Quiz, assessment_identifier: str, title_xml: str) -> str:
    ...
    xml.append(BEFORE_ITEMS.format(assessment_identifier=assessment_identifier,
                                   title=title_xml,
                                   instructions_html_xml=quiz.instructions_html_xml,
    ...
    for question_or_delim in quiz.questions_and_delims:
        ...
        if question.type in ('true_false_question', 'multiple_choice_question',
            ...
            # BBLearn requires feedback
            if question.correct_feedback_raw is None:
                question.correct_feedback_raw = ''
                question.correct_feedback_html_xml = ''

            if question.incorrect_feedback_raw is None:
                question.incorrect_feedback_raw = ''
                question.incorrect_feedback_html_xml = ''
